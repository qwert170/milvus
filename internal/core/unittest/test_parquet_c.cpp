...
NUMERIC_TEST(uint8, uint(milvus::DataType::UINT8), uint8_t, AddUInt8ToPayload, GetUInt8FromPayload, arrow::UInt8Array)
NUMERIC_TEST(uint16, uint(milvus::DataType::UINT16), uint16_t, AddUInt16ToPayload, GetUInt16FromPayload, arrow::UInt16Array)
NUMERIC_TEST(uint32, uint(milvus::DataType::UINT32), uint32_t, AddUInt32ToPayload, GetUInt32FromPayload, arrow::UInt32Array)
NUMERIC_TEST(uint64, uint(milvus::DataType::UINT64), uint64_t, AddUInt64ToPayload, GetUInt64FromPayload, arrow::UInt64Array)
